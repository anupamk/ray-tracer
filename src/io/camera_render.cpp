...
namespace raytracer
{
        ...
        color camera::adaptively_color_a_pixel_at(world const& W, double x, double y, double delta) const
        {
                ...
                /*
                 * 4-corners + 1-center of pixel at (x, y) whose colors we are
                 ...
                 *            |
                 *
                 * so, the ordering of the dx[], and dy[] (below) is
                 * *significant*
                 *
                 * dx[i] and dy[i] *together* defines one corner of the pixel.
                 *
                 **/
                auto const xy_center_color = pixel_color_at(W, x, y);
                auto total_color           = xy_center_color * (1.0 / 5);
                ...
                for (int i = 0; i < 4; i++) {
                        ...
                        /// ----------------------------------------------------
                        /// this is the adaptive computation part.
                        ///
                        ...
                        ///
                        /// this approach is superior to the brute-force
                        /// approach of *always* projecting a fixed number of
                        /// random rays per pixel, and sampling the colors.
                        ...
                        total_color += corner_color * (1.0 / 5.0);
                }
