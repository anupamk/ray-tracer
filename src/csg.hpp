...
namespace raytracer
{
         ...
         **/
        class csg_union : public csg_operation
        {
            public:
                csg_union()  = default;
                ~csg_union() = default;
         ...
         **/
        class csg_intersection : public csg_operation
        {
            public:
         ...
         **/
        class csg_difference : public csg_operation
        {
            public:
         ...
         *    'csg_operation'.
         **/
        class csg_shape : public shape_interface
        {
            private:
